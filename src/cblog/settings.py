...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cokbejqukb14.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones3bucket' # please enter your s3 bucket name
